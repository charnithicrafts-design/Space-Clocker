  ...
  return (
    <div className="p-6 lg:pl-80 space-y-8 min-h-screen bg-surface-lowest text-white pb-32">
      ...
      >
        ...
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-secondary/10 blur-[100px] rounded-full pointer-events-none" />

        <div className="relative z-10 shrink-0">
          <div className="w-40 h-40 rounded-full bg-surface-high border-4 border-primary/30 flex items-center justify-center shadow-[0_0_50px_rgba(var(--color-primary-rgb),0.2)]">
            <Award size={64} className="text-primary" />
          </div>
          <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-primary text-on-primary px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest whitespace-nowrap shadow-lg">
            Level {profile.level}
          </div>
        </div>
        ...
        <div className="relative z-10 flex-1 w-full text-center md:text-left space-y-4">
          <div>
            ...
            <div className="text-secondary font-black uppercase tracking-[0.3em] text-sm mt-1">{profile.title}</div>
          </div>
          ...
          <div className="space-y-2 max-w-md mx-auto md:mx-0">
            <div className="flex justify-between text-[10px] font-black uppercase tracking-widest text-on-surface-variant">
              ...
              <span className="text-primary">{profile.xp} / {XP_PER_LEVEL} XP</span>
            </div>
            <div className="h-3 w-full bg-surface-high rounded-full overflow-hidden border border-outline-variant">
              <motion.div 
                ...
                className="h-full bg-gradient-to-r from-primary to-primary-container shadow-[0_0_10px_rgba(var(--color-primary-rgb),0.8)]"
              />
            </div>
          </div>
