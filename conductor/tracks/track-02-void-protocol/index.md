...
- `Reflection` data structure and store integration.
- `VoidList` UI component with glitch effects.
- `ReflectionModal` UI component.
- Audio feedback for negative actions (`playThud`) and reflection logging (`playSwell`).
