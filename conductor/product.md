...
## Core Values
- **Dopamine Fountain:** Every interaction must feel rewarding. Checkboxes trigger bursts; completions trigger ethereal chimes.
- **Minimal Cognitive Load:** Complexity is revealed only when needed. The interface is clean, futuristic, and intuitive.
- **Reflective Momentum:** Linking daily actions to macro-goals through progress tracking and missed-task reflection logs.

## Core Features
### 1. The Macro Engine (Ambition & Goal Mapping)
- **Goal Deconstructor:** UIs to define high-level ambitions and break them into specific goals.
- **Task Splitter:** A drag-and-drop interface to partition projects into actionable daily tasks.

### 2. The Micro Engine (Daily Action)
- **Task Scheduler:** A daily view with highly satisfying "to-do clicks".
- **The "Void Protocol" (Not-To-Do List):** A section for anti-habits with visual friction and auditory warnings to discourage engagement.

### 3. The Reflection & Momentum Loop
- **Momentum Leveling:** A logic module that tracks deadlines and "levels up" the user upon task completion.
- **Missed Task Reflection:** A modal prompt for short reflections when tasks are missed, encouraging recalibration.
...
A centralized Web Audio API utility providing short, subtle, and organic audio feedback:
- **"To-Do Click":** A soft, crisp "pop" for task completion.
- **"Level Up":** An ascending, ethereal chime for major milestones.
